...
\begin{tabular}{P{11cm}P{53cm}P{12cm}}
\multirow{2}{*}{\makecell{
\includegraphics[width=5cm]{qr.png}\\
\url{eng.uber.com/mh-gan}}}
&
{\fontsize{100}{120} \selectfont \color{NavyBlue} \textbf{\makecell{Metropolis-Hastings\\Generative Adversarial Networks}} \color{Black}}
&
\multirow{2}{*}{\includegraphics[width=11cm]{uber_ai_logo_bootleg.pdf}} \\
&
