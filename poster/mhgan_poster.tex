...
&
\multirow{2}{*}{\includegraphics[width=12cm]{ubai_logo_new.png}} \\
&
...
\newcommand{\unreal}[1]{\fcolorbox{red}{red}{#1}}
\newcommand{\pganw}{1.9in}
%
\begin{center}
%\setlength\tabcolsep{1pt} % default value: 6pt
\begin{tabular}{cc|cc|cc}
\multicolumn{2}{c|}{PGAN (base)} & \multicolumn{2}{c|}{DRS} & \multicolumn{2}{c}{MH-GAN} \\
\toprule
