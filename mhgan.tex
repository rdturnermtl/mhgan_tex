...
We explain out methodology of combing these two very different areas in Section~\ref{sec:MCMC Methods}; here we derive the wrapped generator $G'$.
Section~\ref{sec:MCMC Methods} also discusses a simplified deterministic approximation to the MGAN\@.
Results on real data data (CIFAR-10 and CelebA) abd building on real GAN models (DCGAN and WGAN) are shown in~\ref{sec:Results}.
