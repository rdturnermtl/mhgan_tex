...
Additionally, even if $\vec x_k$ is not exactly distributed according to $\target$, its Kullback-Leibler (KL) divergence to $\target$ will always decrease as $k$ increases~\citep{Murray2008,Cover2012}.
