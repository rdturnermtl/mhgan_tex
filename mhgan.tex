...
We demonstrate the benefits of the improved generator on many benchmark datasets, including CIFAR-10 and CelebA, using DCGAN and WGAN\@.
\end{abstract}
...
% TODO repetition in sentence start to fix
...
A graphical illustration of this sampling is shown in Figure~\ref{fig:univariate_example}.
...
% Because GAN training is a game of sorts, how far ``ahead'' $D$ is will vary by epoch. ## Too informal
...
% Usual wrap up BS paragraph LOL
...
This is the only method in the literature which has the property that given a perfect $D$ one can recover $G$ such that $p_{G} = p_{\text{data}}$. 
