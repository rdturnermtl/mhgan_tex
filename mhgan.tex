...
In general, the proposed successive points are drawn from a conditional distribution $\vec x' \sample \prop(\vec x' \given \vec x_{k-1})$ (the proposal distribution)\@.
...
% TODO consistently make all x_k -> x_k+1
\begin{align}
