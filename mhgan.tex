...
% TODO might want to give state name x here
...
% TODO emphasize that each chain gives one sample from G', might want to move this para to methods
...
% TODO note benefit is invariance to xform => no need to calibrate
...
% DC GAN, WGAN, PGAN
% Use JY scatter plot
% TODO use subfigure ref
% TODO mention CIFAR and DCGAN
...
In all cases we ran the MCMC procedure $K=640$ iterations as in Figure~\ref{}.
We see the same qualitative behavior as in Figure~\ref{} with the MGAN correction providing a siginificant boost in inception score.
