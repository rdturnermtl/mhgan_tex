...
% CROP
%\begin{abstract}
%We introduce the Metropolis Generative Adversarial Network (MGAN), which combines aspect of Markov chain Monte Carlo and GANs.
...
% TODO: talk about what happens when nothing is accepted
