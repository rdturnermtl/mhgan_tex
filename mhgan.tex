...
\begin{figure}[bhtp]
    ...
    \begin{subfigure}[t]{2.25in}
       \centering
       \includegraphics[scale=0.925]{figures/coord_descent.pdf}
       \caption{GAN objective}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{3in}
       \centering
       \includegraphics[scale=0.925]{figures/block_diag.pdf}
       \caption{$G'$ wraps $G$}
    \end{subfigure}
    \caption{{\small
...
The MGAN has flavors of both in that it used both $G$ and $D$ in $G'$.
