...
This is consistent with the results of~\citet{Azadi2018}, where DRS did not increase the number of recovered modes.
...
For real data experiments we considered the CelebA~\citep{Liu2015} and CIFAR-10~\citep{Torralba2008} data sets modeled using the DCGAN~\citep{Radford2015} and WGAN~\citep{Arjovsky2017}.
...
We can see the selectors (such as MH-GAN) results in a widing spread of probability mass across background colors.
