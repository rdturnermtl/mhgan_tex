...
To further illustrate the power of the MH-GAN approach we consider the progressive GAN~\citep{Karras2017}, which recently produced shockingly realistic images.
...
\begin{center}
  \caption{{\small
    Random samples using a pre-trained progressive GAN (PGAN) as the base GAN\@.
    Since the PGAN does not output a probability, we must calibrate the scores by isotonic regression.
    Here we compare 16 \emph{random samples} from the PGAN, calibrated (improved) DRS, and calibrated MH-GAN\@.
...
\toprule
\includegraphics[width=\pganw]{figures/pgan/0_base_raw_base.jpg} &
\includegraphics[width=\pganw]{figures/pgan/1_base_raw_base.jpg} &
\includegraphics[width=\pganw]{figures/pgan/0_base_iso_reject.png} &
\includegraphics[width=\pganw]{figures/pgan/1_base_iso_reject.png} &
\includegraphics[width=\pganw]{figures/pgan/0_base_iso_MH.jpg} &
\includegraphics[width=\pganw]{figures/pgan/1_base_iso_MH.jpg} \\
\includegraphics[width=\pganw]{figures/pgan/2_base_raw_base.jpg} &
\includegraphics[width=\pganw]{figures/pgan/3_base_raw_base.jpg} &
\includegraphics[width=\pganw]{figures/pgan/2_base_iso_reject.png} &
\includegraphics[width=\pganw]{figures/pgan/3_base_iso_reject.png} &
\includegraphics[width=\pganw]{figures/pgan/2_base_iso_MH.jpg} &
\includegraphics[width=\pganw]{figures/pgan/3_base_iso_MH.jpg} \\
\includegraphics[width=\pganw]{figures/pgan/4_base_raw_base.jpg} &
\includegraphics[width=\pganw]{figures/pgan/5_base_raw_base.jpg} &
\includegraphics[width=\pganw]{figures/pgan/4_base_iso_reject.png} &
\includegraphics[width=\pganw]{figures/pgan/5_base_iso_reject.png} &
\includegraphics[width=\pganw]{figures/pgan/4_base_iso_MH.jpg} &
\includegraphics[width=\pganw]{figures/pgan/5_base_iso_MH.jpg} \\
\includegraphics[width=\pganw]{figures/pgan/6_base_raw_base.jpg} &
\includegraphics[width=\pganw]{figures/pgan/7_base_raw_base.jpg} &
\includegraphics[width=\pganw]{figures/pgan/6_base_iso_reject.png} &
\includegraphics[width=\pganw]{figures/pgan/7_base_iso_reject.png} &
\includegraphics[width=\pganw]{figures/pgan/6_base_iso_MH.jpg} &
\includegraphics[width=\pganw]{figures/pgan/7_base_iso_MH.jpg} \\
\includegraphics[width=\pganw]{figures/pgan/8_base_raw_base.jpg} &
\includegraphics[width=\pganw]{figures/pgan/9_base_raw_base.jpg} &
\includegraphics[width=\pganw]{figures/pgan/8_base_iso_reject.png} &
\includegraphics[width=\pganw]{figures/pgan/9_base_iso_reject.png} &
\includegraphics[width=\pganw]{figures/pgan/8_base_iso_MH.jpg} &
\includegraphics[width=\pganw]{figures/pgan/9_base_iso_MH.jpg} \\
\includegraphics[width=\pganw]{figures/pgan/10_base_raw_base.jpg} &
\includegraphics[width=\pganw]{figures/pgan/11_base_raw_base.jpg} &
\includegraphics[width=\pganw]{figures/pgan/10_base_iso_reject.png} &
\includegraphics[width=\pganw]{figures/pgan/11_base_iso_reject.png} &
\includegraphics[width=\pganw]{figures/pgan/10_base_iso_MH.jpg} &
\includegraphics[width=\pganw]{figures/pgan/11_base_iso_MH.jpg} \\
\includegraphics[width=\pganw]{figures/pgan/12_base_raw_base.jpg} &
\includegraphics[width=\pganw]{figures/pgan/13_base_raw_base.jpg} &
\includegraphics[width=\pganw]{figures/pgan/12_base_iso_reject.png} &
\includegraphics[width=\pganw]{figures/pgan/13_base_iso_reject.png} &
\includegraphics[width=\pganw]{figures/pgan/12_base_iso_MH.jpg} &
\includegraphics[width=\pganw]{figures/pgan/13_base_iso_MH.jpg} \\
\includegraphics[width=\pganw]{figures/pgan/14_base_raw_base.jpg} &
\includegraphics[width=\pganw]{figures/pgan/15_base_raw_base.jpg} &
\includegraphics[width=\pganw]{figures/pgan/14_base_iso_reject.png} &
\includegraphics[width=\pganw]{figures/pgan/15_base_iso_reject.png} &
\includegraphics[width=\pganw]{figures/pgan/14_base_iso_MH.jpg} &
\includegraphics[width=\pganw]{figures/pgan/15_base_iso_MH.jpg}
\end{tabular}
\end{center}
\end{table*}
