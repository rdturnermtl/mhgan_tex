...
\begin{center}
  \caption{{\small
    ...
    There are 5 cases where the PGAN produces substantial warpings (red border) while the MH-GAN does not, and 0 cases where the MH-GAN does and the PGAN does not;
