\begin{figure*}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
       \centering
       \includegraphics[width=3.3in]{figures/disc_calib_cifar_flat.pdf}
       \caption{CIFAR-10}
       \label{fig:calibration cifar}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
       \centering
       \includegraphics[width=3.3in]{figures/disc_calib_celeba_flat.pdf}
       \caption{CelebA}
    ...
    The results for CIFAR-10 are shown on the right \textbf{(b)}, and CelebA on the left \textbf{(a)}.
