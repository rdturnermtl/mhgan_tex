\begin{figure*}[htbp]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
       \centering
       \includegraphics[width=2.2in]{figures/per_epoch.pdf}
       \caption{performance by epoch}
       \label{fig:incep_by_epoch}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\textwidth}
       \centering
       \includegraphics[width=2.2in]{figures/plot_per_mh.pdf}
       \caption{performance by MCMC iteration}
       \label{fig:incep_by_iter}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\textwidth}
       \centering
       \includegraphics[width=2.2in]{figures/score_dist_bta.pdf}
       \caption{epoch 13 scores}
       \label{fig:score_dist_overlap}
    \end{subfigure}
    \caption{{\small
    Results of the MH-GAN experiments on CIFAR-10 using the DCGAN\@.
     \textbf{(a)} On the left, we show the Inception score by training epoch of the DCGAN at $K=640$.
    ...
    The error bars on MH-GAN performance (in gray) are computed using a t-test on the variation per batch across 80 splits of the Inception score.
     \textbf{(b)} In the center we show the Inception score vs.~MCMC iteration $k$ for the GAN at epoch 15.
